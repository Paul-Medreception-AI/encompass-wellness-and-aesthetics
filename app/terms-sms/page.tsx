...
export const metadata: Metadata = {
  title: 'Terms and Conditions - SMS | Encompass Wellness and Aesthetics',
  description: 'Encompass Wellness and Aesthetics Terms and Conditions, including SMS messaging terms and compliance.',
  alternates: { canonical: 'https://encompassspa.com/terms-sms' },
}
      ...
      <section className="bg-gradient-to-br from-[var(--color-dark)] to-[var(--color-primary)] py-20 text-white text-center">
        <div className="container mx-auto px-6">
          <h1 className="font-cormorant text-5xl font-bold mb-4 animate-fade-up">
            Encompass Wellness and Aesthetics Terms and Conditions - SMS
          </h1>
          <p className="text-xl text-white/90 max-w-2xl mx-auto animate-fade-up">
            Encompass Wellness and Aesthetics
          </p>
        </div>
      </section>
      ...
      <section className="bg-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-[var(--color-muted)] mb-6">
              If you experience issues with the messaging program, reply with the keyword &quot;HELP&quot; for more assistance, or reach out directly to bsutton@encompassedmond.com or call (405) 254-3000 during business hours.
            </p>
            ...
            <p className="text-[var(--color-muted)] mb-6">
              This website (the &quot;Site&quot;) is owned and operated by Encompass Wellness and Aesthetics (&quot;COMPANY,&quot; &quot;we&quot; or &quot;us&quot;). By using the Site, you agree to be bound by these Terms of Service and to use the Site in accordance with these Terms of Service, our Privacy Policy, and any additional terms and conditions that may apply to specific sections of the Site or to products and services available through the Site or from Encompass Wellness and Aesthetics.
            </p>
            <p className="text-[var(--color-muted)] mb-6">
            ...
            <p className="text-[var(--color-muted)] mb-6">
              This Site and all the materials available on the Site are the property of Encompass Wellness and Aesthetics and/or our affiliates or licensors and are protected by copyright, trademark, and other intellectual property laws. The Site is provided solely for your personal non-commercial use.
            </p>
            <p className="text-[var(--color-muted)] mb-6">
            ...
            <p className="text-[var(--color-muted)] mb-6">
              You agree at all times to indemnify and hold harmless Encompass Wellness and Aesthetics, its affiliates, and their respective officers, directors, agents, and employees from any claims, causes of action, damages, liabilities, costs, and expenses arising out of or related to your breach of any obligation, warranty, or representation under these Terms of Service.
            </p>
            ...
            <p className="text-[var(--color-muted)] mb-6">
              Your participation in any dealings with third-party vendors is solely between you and the third party. Encompass Wellness and Aesthetics shall not be responsible for any loss or damage incurred as a result of such dealings.
            </p>
            ...
            <p className="text-[var(--color-muted)] mb-6">
              If you suspect unauthorized use of your account, notify us immediately at bsutton@encompassedmond.com. We are not liable for any loss or damage arising from your failure to comply with this obligation.
            </p>
            ...
            <p className="text-[var(--color-muted)] mb-6">
              These Terms of Service shall be governed by and construed in accordance with the laws of the State of OK. Any dispute arising under these Terms shall be resolved exclusively through binding arbitration in that jurisdiction.
            </p>
            ...
            <div className="bg-[var(--color-cream)] border border-[var(--color-border)] rounded-lg p-6">
              <p className="text-[var(--color-ink)] font-semibold mb-2">Encompass Wellness and Aesthetics</p>
              <p className="text-[var(--color-muted)] mb-2">Phone: (405) 254-3000</p>
              <p className="text-[var(--color-muted)] mb-2">Email: bsutton@encompassedmond.com</p>
              <p className="text-[var(--color-muted)]">Website: https://encompassspa.com</p>
            </div>
