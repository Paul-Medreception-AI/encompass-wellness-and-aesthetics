...
export default function ConditionsPage() {
  const conditions = [
    ...
    },
    {
      ...
      description: "Vitamin D, B12, iron, and other deficiencies cause fatigue, poor immunity, and chronic health issues. We test micronutrient levels and optimize through targeted supplementation and IV therapy.",
