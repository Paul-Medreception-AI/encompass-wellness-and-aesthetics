...
export const metadata: Metadata = {
  title: 'Privacy Policy | Encompass Wellness and Aesthetics',
  description: 'Encompass Wellness and Aesthetics - Privacy Policy, including SMS, TCPA and HIPAA disclosures.',
  alternates: { canonical: 'https://encompassspa.com/privacy-sms' },
}
    ...
    <main className="min-h-screen bg-white font-opensans">
      <div className="bg-gradient-to-br from-[var(--color-dark)] to-[var(--color-primary)] py-20 text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          <h1 className="font-cormorant text-5xl font-bold mb-4">Encompass Wellness and Aesthetics - Privacy Policy</h1>
          <p className="text-lg text-white/90">Encompass Wellness and Aesthetics</p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="prose prose-lg max-w-none">
          ...
          <ul className="list-disc pl-6 mb-6 text-[var(--color-ink)] space-y-2">
            <li>Reply &quot;HELP&quot; for assistance or contact us at bsutton@encompassedmond.com</li>
